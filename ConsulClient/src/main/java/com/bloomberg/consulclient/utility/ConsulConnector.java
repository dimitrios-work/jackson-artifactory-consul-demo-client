...
public class ConsulConnector {
    ...
    public ConsulConnector(String endpoint) throws MalformedURLException {
        this.endpoint = new URL(endpoint);
    }

    public String get() throws IOException {
        BufferedReader br = new BufferedReader(new InputStreamReader(this.endpoint.openStream()));
